...
BLOG_AUTHOR = "Boomslang Tech"  # (translatable)
BLOG_TITLE = "Boomslang Tech Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.boomslang.mx/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.boomslang.mx/"
BLOG_EMAIL = "contacto@boomslang.mx"
BLOG_DESCRIPTION = "Boomslang Tech Blog"  # (translatable)
